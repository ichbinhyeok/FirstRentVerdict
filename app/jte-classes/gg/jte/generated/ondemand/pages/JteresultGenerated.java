...
public final class JteresultGenerated {
	...
	public static final int[] JTE_LINE_INFO = {0,0,1,2,4,4,4,7,7,10,10,22,22,24,24,26,26,28,28,31,32,32,33,34,34,38,38,39,39,41,41,41,42,42,42,44,44,46,46,46,47,49,49,49,49,49,49,52,52,53,53,56,56,60,60,60,62,62,65,65,65,67,67,69,69,71,71,75,75,78,78,78,80,80,83,83,85,85,87,87,87,88,88,88,88,92,92,95,95,95,97,97,100,100,103,104,104,104,104,110,110,115,115,117,117,117,119,119,123,123,123,140,140,140,143,143,143,143,143,143,143,143,143,144,144,144,144,144,144,144,144,144,166,166,166,168,173,176,176,179,179,179,180,180,180,182,182,182,184,184,192,194,194,194,195,197,200,201,202,203,203,203,203,204,204,204,204,207,207,207,213,214,214,216,216,216,216,217,217,217,220,220,223,223,223,223,224,224,224,230,234,234,234,270,273,285,292,304,305,313,319,323,327,348,353,354,372,428,428,428,429,429,429,4,5,5,5,5};
	public static void render(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, VerdictResult result, boolean noindex) {
		...
		}, "Your Rent Verdict Result - Confidential", "Standardize your rental financial risk interaction with the 50/30/20 rule. First Rent Verdict provides objective affordability analysis for new tenants.", null, true);
		jteOutput.writeContent("\r\n");
	}
	public static void renderMap(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, java.util.Map<String, Object> params) {
		VerdictResult result = (VerdictResult)params.get("result");
		boolean noindex = (boolean)params.getOrDefault("noindex", true);
		render(jteOutput, jteHtmlInterceptor, result, noindex);
	}
}
